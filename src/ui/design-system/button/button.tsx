...
export default function Button({
  ...
  switch (variant) {
    case "accent":
      ...
      break;
    case "primary":
      variantStyles = "bg-gray-500 hover:bg-gray-500 text-gray-50";
      break;
    case "suivant":
      variantStyles =
        "bg-primary-1 hover:text-white hover:bg-primary text-gray";
      break;
    case "secondary":
    ...
    <>
      <button
        ...
        className={clsx(
          ...
          "relative animate",
          fullwidth && "w-full",
          isFocused && "outline-none ring-2 ring-gray-950" // Ajout du style de focus
        )}
        onClick={handClick}
